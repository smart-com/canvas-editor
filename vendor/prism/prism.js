/* http://prismjs.com/download.html?themes=prism-dark&languages=clike+javascript&plugins=line-highlight+file-highlight+previewer-base+previewer-color+previewer-gradient+previewer-easing+previewer-time+previewer-angle */
...
/* Добавила подсветку ctx */
Prism.languages.javascript = Prism.languages.extend('clike', {
	'keyword': /\b(ctx|as|async|await|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|var|void|while|with|yield)\b/,
